...
var modified_date= File.GetLastWriteTime(Environment.GetCommandLineArgs()[1]);
var creation_date= File.GetCreationTime(Environment.GetCommandLineArgs()[1]);
var accessed_date= File.GetLastAccessTime(Environment.GetCommandLineArgs()[1]);
